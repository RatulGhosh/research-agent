...
| `deep_think_llm` | `gpt-5.6` | Default model for the two judges |
| `quick_think_llm` | `gpt-5.6-terra` | Default model for analysts and debaters |
...
config["role_llms"] = {
    ...
    "Novelty Analyst":  {"provider": "openai",    "model": "gpt-5.6"},
}
```
...
config["web_search"] = {
    ...
    "model": None,             # None -> gpt-5.6 / claude-opus-5
